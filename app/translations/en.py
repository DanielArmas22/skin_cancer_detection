translations = {
    ...
    'layers': '**Layers:**',
    'hybrid_models': '🧠 Advanced Hybrid Models',
    'hybrid_models_available': '✅ Hybrid models available:',
    'no_hybrid_models': '⚠️ No hybrid models detected',
    'train_hybrid_models': '🚀 Train Hybrid Models',
    'train_hybrid_help': 'Starts training of advanced hybrid models. This process may take several hours.',
    'training_in_progress': 'Training in progress...',
    'training_completed': '✅ Training completed!',
    'training_error': '❌ Error:',
    'reloading': '🔄 Reloading to detect new models...',
